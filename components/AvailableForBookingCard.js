...
function AvailableForBookingCard({rooms}) {
    return (
        <div className='grid md:grid-cols-3 grid-cols-2 w-full h-auto items-center gap-x-2 gap-y-3'>

            {rooms.map((room) => (<div className="box rounded-2xl bg-white border-[1.5px] border-[#E4E4E4] flex flex-col items-center p-4 md:p-6 gap-4 h-auto">
