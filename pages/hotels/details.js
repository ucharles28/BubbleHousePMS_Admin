                                ...
                                <div className='flex flex-col gap-3 items-center'>
                                    ...
                                    <div className="rounded-lg h-28 w-28 bg-[#1A1A1A]/25 flex items-center">
                                        ...
                                        {!hotelImageSrc ? <span className='flex items-center justify-center m-auto'>
                                            ...
                                            <img src={hotelImageSrc} className='rounded-lg h-28 w-28 bg-[#1A1A1A]/25 object-cover' />}
                                    </div>
                                    ...
                                    <button
                                        type="button"
                                        className="text-white font-medium flex items-center px-3 py-2 rounded-md bg-[#1a1a1a]/50 text-xs leading-6 uppercase hover:bg-[#666666]"
                                        onClick={handleClick}
                                    >
                                        Upload photo
                                    </button>
                                    ...
                                    <button
                                        type="button"
                                        className="text-[#666666] font-medium flex items-center px-3 py-1.5 rounded-md border-[#1a1a1a]/50 border-[1.2px] text-xs leading-6 uppercase hover:bg-[#666666] hover:text-white"
                                        onClick={clearImage}
                                    >
                                        Reset
                                    </button>
                            ...
                            <div className='item w-full h-full'>
                                <div className='flex flex-col gap-4 w-full'>
                                    ...
                                    <textarea
                                        ...
                                        rows={4}
                                        className='w-full border border-[#666666]/50 placeholder:text-[#636363] text-xs font-normal p-3 pl-2 bg-transparent rounded-md focus:outline-2 focus:outline-offset-2'
                                        value={description}
